...
from .forms import CheckoutForm, CouponForm, ProfileForm, RefundForm, UserForm
...
def products(request, slug):
    if request.method == "GET":
        ...
        request.user.profile.object_list.add(Item)
    ...
    return render(request = request, template_name="shop.html", context = { "page_obj":page_obj})
